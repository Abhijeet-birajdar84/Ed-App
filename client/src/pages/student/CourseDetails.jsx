...
const toggleSection = (index)=>{
  ...
  return courseData ? (
    ...
    md:px-36 px-8 md:pt-30 pt-20 text-left top-0 left-0 w-full h-full bg-gradient-to-b
       from-cyan-100/70'>
      
      <div className='absolute top-0 left-0 w-full bg-gradient-to-b
       from-cyan-100/70'></div>


      {/* left column */}
      <div className='max-w-xl z-10 text-gray-500'>
        <h1 className='md:text-5xl text-course-deatails-heading-small-[26px, 36px] 
        ...
        {/* review and rating */}
           <div className='flex items-center space-x-2 pt-3 pb-1 text-sm'>
                   <p> 4.3</p>  {/*  //{calculateRating(courseData)} */}
                    <div className='flex'>
                    ...
                    <p className='text-gray-500'>231</p><p className='text-blue-600'>Ratings</p>
                      
                  </div>

                  <p className='text-sm'>Course by <span className='text-blue-600 underline'>Skyscraper</span></p>
       ...
       {/* right column */}
      <div className='max-w-course-card-[424px] z-10 shadow-[0_4px_16px_2px_rgba(0,0,0,0.1)] p-1.5 rounded rounded-t md:rounded-none 
...

      {
        ...
        :    <img src={courseData.courseThumbnail} alt="" />
          ...
          <div className='p-5'>
              ...
              <div className='flex items-center text-sm md:text-2xl gap-4 pt-2 md:pt-4 text-gray-500'>
                  <div className='flex items-center gap-1'>
                    <img src={assets.star} alt="star icon" />
                    <p className='text-sm'>231 Rating</p>
                  </div>
              ...
              <div className='pt-6'>
                ...
                <ul className='ml-4 pt-2 text-sm md:text-[17px] list-disc text-gray-500'>
